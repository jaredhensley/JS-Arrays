...
function removeItem(list, item) {
  list.forEach(function (value, index) {
    if (value === item) list.splice(index, 1);
  })
  return list;
}

console.log(removeItem(myGroceryList, "corndogs"));
//Code Here
...
devMountainEmployees.forEach(function (value, index) {
  if (value.name === "Cahlan") {
    console.log(devMountainEmployees.splice(index, 1));
  }
});
